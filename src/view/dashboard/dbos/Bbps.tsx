    ...
    <div className="main">
      ...
      <div className="mainpagehead dbos">
        <Top1image
          ...
          img={
            "https://cdn3d.iconscout.com/3d/premium/thumb/wifi-bill-payment-2869820-2384382.png"
          }
        />
        <Twoslides
          classname={"col-12 col-xl-11  mx-auto two-slides"}
          img1="https://cdn3d.iconscout.com/3d/premium/thumb/mobile-recharge-2870163-2386915.png"
          h1={`BBPS & Recharge Services`}
          li1={`Retailers can open new gateways for their business by providing a wide range of BBPS services using RapiPay’s portal or app. They can make their shop a one-stop solution for all bill payments like electricity, telecom, gas, water, FasTag recharge and many more. Not just bill payments, RapiPay agents (DBOs) can also provide mobile and DTH recharges to their consumers. All major mobile and DTH service providers’ recharge plans are available.`}
          li2={`By joining RapiPay’s vast network of Fintailers, a retailer can provide convenient, safe, and reliable bill payment and recharge services to their customers and help them pay their bills digitally. This additional service also ensures that the retailers earn great commissions on every recharge.`}
        />
          ...
          <div className="vh-100 service">
            ...
            <div className="service-content text-center">
              <h1 className="mb-5">
                Why Start
                <br />
                <strong>Bill Payment & Recharge Business with RapiPay</strong>
              </h1>
              <div className="col-lg-10 d-flex flex-wrap align-items-center justify-content-evenly service-box">
                <Circle
                  img={
                    "https://in.rapipay.com/wp-content/uploads/2022/12/bill-.png"
                  }
                ...
                <Circle
                  img={
                    "https://in.rapipay.com/wp-content/uploads/2022/12/confirmation.png"
                  }
